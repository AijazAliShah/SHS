...
class index extends Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `${baseUrl}api/services/app/Chat/GetInitialChatByUser?UserId=` +
        fromId,
      {
        headers: {
                  ...
                  <div class="img_cont">
                    <span>
                      ...
                      >
                        ...
                        >
                          {key.userFrom.name.charAt(0).toUpperCase()}
                        </h3>
                      </p>
                    </span>
                    {/* <img
      ...
      <div className="MainDiv">
        <section>
          ...
          >
            ...
            <div className="chat-image-side-section">

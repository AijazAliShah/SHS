          ...
          responseData => {
            if (!responseData.success) {
              ...
              fetch(
                ...
                .then(function(response) {
                  console.log("rREEEEEEES",responseData)
                  // return {
                  //   success: true
                  // }; 
                  return response.json(); //response.json() is resolving its promise. It waits for the body to load
                ...
                .then(
                  responseData => {
                    console.log("rREEEEEEES222",responseData)
                    if (!responseData.success) {
                      SweetAlert(
                        <div className="alert alert-danger fade show">
                          <h1>
            ...
            <div class="col-md-12">
              <div class="d-flex justify-content-center">
                <span class="profile-name">
                  <p class="profile-name-p text-uppercase pb-5" style={{fontSize:'30px',color:'#fff'}}>
              ...
              <form onSubmit={this.userRegistration}>
                ...
                <div class="col-md-12 ">
                  <div class=" row">
                    ...
                    <div class="col-md-6 input-effect-profile mt-5">
                      <label>{this.props.t("phone_req")}</label>
                ...
                <div class="col-md-12 ">
                  <div class=" row">
                    <div class="col-md-12 input-effect-profile mt-5">
                      <label>{this.props.t("username_req")}</label>
                ...
                <div class="col-md-12 ">
                  <div class=" row">
                    <div class="col-md-12 input-effect-profile mt-5">
                      <label>{this.props.t("id_req")}</label> <br />
                      {this.state.idLabel ? (
                        <label className="text-danger">
                          {this.props.t("id_req")}
                        </label>
                ...
                <div class="col-md-12 ">
                  <div class=" row">
                    <div class="col-md-12 input-effect-profile mt-5">
                      <label>{this.props.t("work_interest")}</label>
                      <br />

                      {this.state.workIntrestLabel ? (
                        <label className="text-danger">
                          {this.props.t("select_at_least_one_work_interest")}
                        </label>
                      ) : null}
                      <Multiselect
                ...
                <div class="col-md-12 ">
                  <div class=" row">
                    <div class="col-md-12 input-effect-profile mt-5">
                      <label>{this.props.t("address_star")}</label>
                      <br />
                ...
                <div class="col-md-12 ">
                  <div class=" row">
                    <div class="col-md-12 input-effect-profile mt-5">
                      <label>{this.props.t("district_star")}</label>
                      <br />
